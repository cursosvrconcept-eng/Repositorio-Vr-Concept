        ...
        <div className="max-w-6xl mx-auto bg-brand-charcoal/40 backdrop-blur-md border border-brand-gold/20 rounded-3xl p-8 md:p-16 flex flex-col lg:flex-row items-center gap-12 lg:gap-20 shadow-2xl">
          ...
          <div className="text-center lg:text-left flex-1">
            <h2 className="font-serif text-3xl md:text-5xl text-white mb-8 leading-tight">
              7 dias de garantia <span className="text-brand-gold block md:inline">incondicional</span>
            </h2>
            
            <div className="space-y-6 text-gray-300 text-lg md:text-xl leading-relaxed font-light">
                <p>
                    Acesse o material. Estude o conteúdo. <strong className="text-white font-medium">Teste no próximo caso.</strong>
                </p>
                <p>
                    Se não fizer sentido, manda um e-mail. <span className="text-brand-gold font-bold underline decoration-brand-gold/30 underline-offset-4">Devolvemos 100% do valor.</span>
                </p>
                
                <div className="flex flex-wrap justify-center lg:justify-start gap-4 md:gap-8 py-2">
                    <span className="flex items-center gap-2 text-white font-medium"><div className="bg-green-500/20 p-1 rounded-full"><Check className="w-4 h-4 text-green-500"/></div> Sem perguntas</span>
                    <span className="flex items-center gap-2 text-white font-medium"><div className="bg-green-500/20 p-1 rounded-full"><Check className="w-4 h-4 text-green-500"/></div> Sem burocracia</span>
                </div>
                ...
                <div className="bg-white/5 border-l-4 border-brand-gold p-4 md:p-6 rounded-r-lg mt-6">
                    <p className="text-gray-200 italic text-base md:text-lg">
                        "Essa garantia existe porque o conteúdo funciona. E queremos que você tenha total segurança na decisão."
                    </p>
                </div>
            </div>
