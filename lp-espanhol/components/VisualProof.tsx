    ...
    <section className="py-16 md:py-24 bg-black relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 md:px-6 relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 xl:gap-16 max-w-6xl mx-auto items-start relative">
          ...
          {/* Connector Arrow (Desktop Only) - Positioned to center relative to images approximately */}
            ...
            <div className="p-6 md:p-8 bg-gradient-to-b from-brand-charcoal to-brand-black border-t border-white/5 relative z-10">
                <div className="space-y-4">
                    <div className="flex items-center justify-between text-gray-400 border-b border-white/10 pb-3">
                        <span className="text-xs md:text-sm uppercase tracking-wider font-medium">Inmediato</span>
                        <span className="text-white font-serif italic text-sm md:text-base">Espejada</span>
                    </div>
                    <div className="flex items-center justify-between text-red-300 border-b border-white/10 pb-3">
                        <span className="text-xs md:text-sm uppercase tracking-wider font-medium opacity-80">7 Días</span>
                        <span className="font-bold text-red-400 text-sm md:text-base">Opaca, sin vida</span>
                    </div>
                    <div className="flex items-center justify-between text-red-300">
                        <span className="text-xs md:text-sm uppercase tracking-wider font-medium">30 Días</span>
            ...
            <div className="p-6 md:p-8 bg-gradient-to-b from-brand-charcoal to-brand-black border-t border-brand-gold/20 relative z-10">
                ...
                <div className="space-y-4">
                    <div className="flex items-center justify-between text-emerald-100 border-b border-brand-gold/10 pb-3">
                        <span className="text-xs md:text-sm uppercase tracking-wider font-medium">Inmediato</span>
                        <span className="text-white font-serif italic text-sm md:text-base">Efecto Vidro</span>
                    </div>
                    <div className="flex items-center justify-between text-brand-gold border-b border-brand-gold/10 pb-3">
                        <span className="text-xs md:text-sm uppercase tracking-wider font-medium text-emerald-100/80">7 Días</span>
                        <span className="font-bold text-sm md:text-base">Brillo Intacto</span>
                    </div>
                    <div className="flex items-center justify-between text-brand-gold">
                        <span className="text-xs md:text-sm uppercase tracking-wider font-medium text-emerald-100/80">30 Días</span>
                        <span className="font-bold text-sm md:text-base">Idéntica al día 1</span>
                    </div>
                </div>
            </div>
          </div>
        ...
        <div className="text-center mt-12 md:mt-20">
          <p className="inline-block text-xl md:text-3xl font-serif italic text-gray-300 leading-relaxed border-b border-brand-gold/30 pb-4 px-4">
            "La diferencia no está en la resina. <br className="md:hidden" /> Está en la secuencia técnica de pulido."
          </p>
        </div>
      </div>
    </section>
