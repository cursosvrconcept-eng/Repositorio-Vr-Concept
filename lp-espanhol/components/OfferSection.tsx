...
const OfferSection: React.FC = () => {
  const benefits = [
    "Guía Completa en PDF (protocolo paso a paso)",
    "Checklist Clínico (imprimible)",
    "Tabla de Materiales (marcas y rotaciones exactas)",
      ...
      <div className="container mx-auto px-4 md:px-6 relative z-10">
        <div className="max-w-2xl mx-auto">
                ...
                <div className="p-6 md:p-12 relative z-10">
                    ...
                    <div className="text-center bg-brand-charcoal/30 -mx-6 md:-mx-12 px-6 md:px-12 py-8 md:py-10 border-t border-white/5 border-b border-white/5 backdrop-blur-sm relative">
                        ...
                        <div className="flex flex-col items-center justify-center gap-1 mb-8">
                            <p className="text-gray-500 text-base md:text-lg line-through font-medium">De $ 47.00</p>
                            
                            <div className="flex flex-col items-center">
                                <span className="text-brand-gold font-bold uppercase tracking-wider text-[10px] md:text-sm mb-1">Por solo</span>
                                <div className="flex items-baseline gap-1">
                                    <span className="text-2xl md:text-3xl text-white font-serif">$</span>
                                    <span className="text-5xl md:text-7xl font-serif font-bold text-transparent bg-clip-text bg-gradient-to-b from-brand-goldLight to-brand-gold drop-shadow-sm">9</span>
                                    <span className="text-2xl md:text-3xl text-white font-serif">.00</span>
                                </div>
                            </div>
                            
                            <p className="text-gray-400 mt-2 font-medium text-sm md:text-base">Acceso de por vida</p>
                        </div>
                        ...
                        <Button variant="primary" fullWidth pulsing className="text-base md:text-xl py-4 md:py-5 shadow-[0_0_30px_rgba(201,166,97,0.4)] hover:shadow-[0_0_50px_rgba(201,166,97,0.6)] transform hover:-translate-y-1 transition-all duration-300 whitespace-normal h-auto">
                            <span className="flex flex-col sm:flex-row items-center gap-1 sm:gap-2">
                                <span>GARANTIZAR ACCESO POR</span>
                    ...
                    <div className="mt-8 relative z-10">
                        <div className="bg-brand-charcoal/50 border border-brand-gold/10 rounded-xl p-5 md:p-6 flex gap-4 items-start hover:border-brand-gold/20 transition-colors">
                            ...
                            <div>
                                <p className="text-brand-gold font-bold text-sm mb-1 uppercase tracking-wide">¿Por qué este precio?</p>
                                <p className="text-xs md:text-sm text-gray-400 leading-relaxed font-light">
                                    Este es un MVP. Estoy validando si los dentistas quieren contenido técnico directo, sin rodeos. Si funciona, el precio sube. Pero quien entra ahora, paga $ 9.00 y tiene acceso de por vida.
                                </p>
                            </div>
                        </div>
                    </div>
            ...
            <div className="text-center mt-6 flex items-center justify-center gap-2 opacity-60">
                ...
                <p className="text-[10px] md:text-xs text-gray-400 uppercase tracking-widest">Pago Seguro • Acceso Inmediato</p>
            </div>
